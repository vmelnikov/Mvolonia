            ...
            return new FuncControlTemplate<GroupingListBox>((parent, scope) =>
                new ScrollViewer
                {
                    ...
                    Content = new GroupingItemsPresenter
                    {
                        ...
                        [~ItemsPresenterBase.ItemsProperty] = parent.GetObservable(ItemsControl.ItemsProperty).ToBinding(),
                        [~ItemsPresenterBase.ItemsPanelProperty] = parent.GetObservable(ItemsControl.ItemsPanelProperty).ToBinding(),
